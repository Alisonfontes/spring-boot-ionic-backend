package com.alisonshow.cursomc;
...
import com.alisonshow.cursomc.domain.Estado;
import com.alisonshow.cursomc.domain.ItemPedido;
import com.alisonshow.cursomc.domain.Pagamento;
import com.alisonshow.cursomc.domain.PagamentoComBoleto;
import com.alisonshow.cursomc.domain.PagamentoComCartao;
...
import com.alisonshow.cursomc.repositories.EstadoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Produto p4 = new Produto(null, "Mesa escri´torio", 300.00);
		Produto p5 = new Produto(null, "Toalha", 50.00);
		Produto p6 = new Produto(null, "COlcha", 200.00);
		Produto p7 = new Produto(null, "Tv true color", 1200.00);
		Produto p8 = new Produto(null, "Roçadeira", 800.00);
		Produto p9 = new Produto(null, "Abaju", 100.00);
		Produto p10 = new Produto(null, "Pedante", 180.000);
		Produto p11 = new Produto(null, "Shampoo", 12.68);
